...
// import { DataSourceDefinition, QueryPerform } from '../types/datasource.types'
...
// 	let llanaRolesTableSchema: DataSourceDefinition
...
// 		schema = app.get<Definition>(Definition)
// 		//logger = app.get<Logger>(Logger)
// 		query = app.get<Query>(Query)

// 		llanaRolesTableSchema = await schema.getSchema({ tableOrView: LLANA_ROLES_TABLE })
...
// 			await query.perform(QueryPerform.TRUNCATE, { definition: schema })
...
// 				definition: llanaRolesTableSchema,
// 				data: <DefaultRole>{
// 					custom: false,
// 					role: 'ADMIN',
